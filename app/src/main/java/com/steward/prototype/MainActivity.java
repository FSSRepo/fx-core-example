...
public class MainActivity extends ForceXApp 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		addFolder("proto");
        initialize(new PrototypeUNI(this),true);
    }
	
	public static class PrototypeUNI extends Game implements InputListener {
		UIContext ctx;
		SlidePanel panel;
		...
		public PrototypeUNI(MainActivity app){
			this.app = app;
		}
		...
		public void create() {
			...
			*/
			...
			TextView AppName = new TextView(ctx.default_font);
			AppName.setText("Prototype documental research");
			AppName.setTextSize(0.06f);
			
			// Texto Integrantes
			TextView Integrantes = new TextView(ctx.default_font);
			...
			*/
			...
			main.add(lv);
			btnMenuPhy = new Button("Menu",ctx.default_font,0.06f,0.05f);
			...
			main.add(btnMenuPhy);
			tvCollisionInfo = new TextView(ctx.default_font);
		...
		private void prepareMenu(){
			...
			TextView tvSim = new TextView(ctx.default_font);
			...
			tvTimer = new TextView(ctx.default_font);
			...
			Button btnMenuReset = new Button("Reiniciar",ctx.default_font,0.13f,0.07f);
			...
			Button btnAdd = new Button("Agregar Mas",ctx.default_font,0.13f,0.07f);
			...
			Button btnCerrarPhy = new Button("Salir",ctx.default_font,0.13f,0.07f);
		...
		*/
		...
		private void prepareGraphicator(){
			...
			Button close = new Button("Cerrar",ctx.default_font,0.18f,0.05f);
		...
		private void prepareCalculator(){
			...
			Layout container = new Layout(ctx);
			container.setToWrapContent();
			TextView tvInput = new TextView(ctx.default_font);
			...
			tvResult = new TextView(ctx.default_font);
			...
			btnCalcular = new Button("Calcular",ctx.default_font,0.15f,0.07f);
			btnCalcular.setApplyAspectRatio(true);
			btnCalcular.setTextSize(0.06f);
			btn_container.add(btnCalcular);
			Button close = new Button("Cerrar",ctx.default_font,0.15f,0.07f);
			close.setApplyAspectRatio(true);
			close.setTextSize(0.06f);
			close.setMarginTop(0.02f);
	...
	*/
	static class ImageAdapter extends ListAdapter<ImageItem> {
		...
		@Override
		protected void updateView(MainActivity.ImageItem item, short position, Layout container) {
